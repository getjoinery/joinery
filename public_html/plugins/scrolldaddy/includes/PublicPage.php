...
<head>
    ...
    <link rel="stylesheet" href="/plugins/scrolldaddy/assets/css/scrolldaddy-plugin.css?v=4">
    ...
    <div class="th-menu-wrapper">
        <div class="th-menu-area text-center">
 		...
 		<?php
			...
			if($session->get_user_id()){
				echo '<li><a href="/profile/scrolldaddy/devices">Devices</a></li>';
				echo '<li><a href="/profile">Settings</a></li>';
				echo '<li><a href="/logout">Log out</a></li>';
			}
			else{
				if($settings->get_setting('register_active')){
					echo '<li><a href="/scrolldaddy/pricing">Sign up</a></li>';
				}
