...
<head>
	...
	============================== -->
    <!-- Bootstrap -->
    <!--<link rel="stylesheet" href="/plugins/scrolldaddy/assets/css/bootstrap.min.css">-->
	<link href="https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/css/bootstrap.min.css" rel="stylesheet">
    <!-- Fontawesome Icon -->
    <link rel="stylesheet" href="/plugins/scrolldaddy/assets/css/fontawesome.min.css">
	<!--<link href="https://cdn.jsdelivr.net/npm/@r3dz0n3/fontawesome-pro@6.3.0/css/fontawesome.min.css" rel="stylesheet">-->
    <!-- Magnific Popup -->
    <!--<link rel="stylesheet" href="/plugins/scrolldaddy/assets/css/magnific-popup.min.css">-->
        ...
        <div class="sidemenu-content">
            ...
            <div class="widget footer-widget">
                ...
                <div class="recent-post-wrap">
                    <div class="recent-post">
                        <div class="media-img">
                            <a href="blog-details.html"><img src="/plugins/scrolldaddy/assets/img/blog/recent-post-1-1.jpg" alt="Blog Image"></a>
                        </div>
                    ...
                    <div class="recent-post">
                        <div class="media-img">
                            <a href="blog-details.html"><img src="/plugins/scrolldaddy/assets/img/blog/recent-post-1-2.jpg" alt="Blog Image"></a>
                        </div>
                        <div class="media-body">
                            <h4 class="post-title"><a class="text-inherit" href="blog-details.html">The Benefits of Managed IT Services post could</a></h4>
                            <div class="recent-post-meta">
                    ...
                    <div class="recent-post">
                        <div class="media-img">
                            <a href="blog-details.html"><img src="/plugins/scrolldaddy/assets/img/blog/recent-post-1-3.jpg" alt="Blog Image"></a>
                        </div>
                        <div class="media-body">
                            <h4 class="post-title"><a class="text-inherit" href="blog-details.html">The Benefits of Managed IT Services post could</a></h4>
                            <div class="recent-post-meta">
            ...
            <div class="widget footer-widget">
                ...
                <div class="th-widget-contact">
                    <div class="info-box">
                        <div class="box-icon">
                            <img src="/plugins/scrolldaddy/assets/img/icon/location.svg" alt="">
                        </div>
                        <p class="box-text">55 Main Street, 2nd block Malborne, Australia</p>
                    </div>
                    <div class="info-box">
                        <div class="box-icon">
                            <img src="/plugins/scrolldaddy/assets/img/icon/mail.svg" alt="">
                        </div>
                        <p class="box-text">
                    ...
                    <div class="info-box">
                        <div class="box-icon">
                            <img src="/plugins/scrolldaddy/assets/img/icon/call.svg" alt="">
                        </div>
                        <p class="box-text">
...
============================== -->
    ...
    <!--<script src="/plugins/scrolldaddy/assets/js/vendor/jquery-3.7.1.min.js"></script> //LOADED IN THE HEADER-->
	<!-- Joinery Validation (Pure JS, no jQuery dependency) -->
	<script src="/assets/js/joinery-validate.js"></script>
    <!-- Swiper Slider -->
    <script src="/plugins/scrolldaddy/assets/js/swiper-bundle.min.js"></script>
    <!-- Bootstrap -->
    <!--<script src="/plugins/scrolldaddy/assets/js/bootstrap.min.js"></script>-->
	<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/js/bootstrap.min.js"></script>
    <!-- Magnific Popup -->
    <!--<script src="/plugins/scrolldaddy/assets/js/jquery.magnific-popup.min.js"></script>-->
	<script src="https://cdn.jsdelivr.net/npm/magnific-popup@1.2.0/dist/jquery.magnific-popup.min.js"></script>
    <!-- Counter Up -->
    <!--<script src="/plugins/scrolldaddy/assets/js/jquery.counterup.min.js"></script>-->
    <!-- Circle Progress -->
    <!--<script src="/plugins/scrolldaddy/assets/js/circle-progress.js"></script>-->
    <!-- Range Slider -->
    <!--<script src="/plugins/scrolldaddy/assets/js/jquery-ui.min.js"></script>-->
	<script src="https://cdn.jsdelivr.net/npm/jquery-ui@1.14.1/dist/jquery-ui.min.js"></script>
    <!-- Imagesloadedr -->
    <!--<script src="/plugins/scrolldaddy/assets/js/imagesloaded.pkgd.min.js"></script>-->
    <!-- isotope -->
    <!--<script src="/plugins/scrolldaddy/assets/js/isotope.pkgd.min.js"></script>-->
    <!-- Tilt.jquery -->
    <!--<script src="/plugins/scrolldaddy/assets/js/tilt.jquery.min.js"></script>-->
    <!-- Nice-select -->
    <!--<script src="/plugins/scrolldaddy/assets/js/nice-select.min.js"></script>-->
    <!-- wow -->
    <!--<script src="/plugins/scrolldaddy/assets/js/wow.min.js"></script>-->
