			...
			echo '
					...
					<div class="job-post_author">
						<div class="job-wrapp">
							...
							<div class="author-info">
								<h3 class="company-name">Connection Details</h3>
								<h5 class="price">DoH URL and setup instructions</h5>
							</div>
						</div>
						<a class="th-btn style5" href="/profile/ctld_activation?device_id='.$device->key.'">Set Up</a>
					</div>
					</div>
				</div>';
