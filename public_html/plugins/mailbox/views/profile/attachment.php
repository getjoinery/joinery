<?php
/**
 * Member per-attachment download endpoint (/profile/mailbox/attachment).
 *
...
require_once(PathHelper::getThemeFilePath('profile_attachment_logic.php', 'logic', 'system', null, 'mailbox'));
