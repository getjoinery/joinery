...
$altlinks = array('New Alias' => '/plugins/mailbox/admin/admin_mailbox_alias');
...
foreach ($aliases as $alias) {
	...
	$rowvalues = array();
	array_push($rowvalues, '<a href="/plugins/mailbox/admin/admin_mailbox_alias?iea_inbound_email_alias_id=' . $alias->key . '">' . htmlspecialchars($full_address) . '</a>');
