 ...
 *                    not yet created
 *   booting        - instance created; waiting for running + public IP
 *   provisioning   - SSH provisioning underway (the long step)
 *   done | failed  - terminal. BOTH erase the sealed token and SSH key
 *                    (grant-per-act custody); a failure destroys the instance
 *                    it created within the same grant.
...
class RelayCloudProvision extends SystemBase {
	...
	public static $field_specifications = array(
		...
		'rcp_kind'            => array('type'=>'varchar(10)', 'is_nullable'=>false, 'default'=>'provision', 'allowed_values'=>array('provision')),
