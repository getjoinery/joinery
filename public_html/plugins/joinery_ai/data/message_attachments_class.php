 ...
 * (aia_aim_conversation_message_id → aim_conversation_messages, aia_fil_file_id → fil_files)
...
class AiMessageAttachment extends SystemBase {
    ...
    public static $pkey_column = 'aia_message_attachment_id';

    /**
     * Deleting the underlying File cascades the link row away.
     *
     * The message → attachment edge (aia_aim_conversation_message_id) also auto-registers,
    ...
    protected static $foreign_key_actions = [
        ...
        'aia_aim_conversation_message_id' => ['action' => 'cascade'],
    ];

    public static $field_specifications = array(
        'aia_message_attachment_id'   => array('type'=>'int8', 'is_nullable'=>false, 'serial'=>true),
        ...
        'aia_aim_conversation_message_id'  => array('type'=>'int8', 'required'=>true, 'index'=>true),
        ...
        // extracted-text read path resolve the message DEK from aia_aim_conversation_message_id.
     ...
     * (resolved via aia_aim_conversation_message_id in ChatSeal), so decryption loads that
    ...
    public static function conversationRefs(int $conversation_id): array {
        ...
        $sql = 'SELECT a.aia_fil_file_id AS file_id '
             ...
             . 'ORDER BY a.aia_message_attachment_id ASC';
        try {
...
class MultiAiMessageAttachment extends SystemMultiBase {
    ...
    protected function getMultiResults($only_count = false, $debug = false) {
        ...
        if (isset($this->options['message_id'])) {
            $filters['aia_aim_conversation_message_id'] = [$this->options['message_id'], PDO::PARAM_INT];
        }
