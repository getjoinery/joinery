...
class AipRecipeItemLog extends SystemBase {
    ...
    public static $pkey_column = 'aip_recipe_item_log_id';
    ...
    protected static $foreign_key_actions = array(
        ...
        'aip_rcr_recipe_run_id' => array('action' => 'cascade'),
    );
    ...
    public static $field_specifications = array(
        'aip_recipe_item_log_id'         => array('type'=>'int8', 'is_nullable'=>false, 'serial'=>true),
        ...
        'aip_rcr_recipe_run_id'     => array('type'=>'int8'),
