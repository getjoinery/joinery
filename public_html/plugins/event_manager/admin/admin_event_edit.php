...
require_once(PathHelper::getIncludePath('plugins/event_manager/admin/logic/admin_event_edit_logic.php'));

$page_vars = process_logic(admin_event_edit_logic(array_merge($_GET, $_POST)));
extract($page_vars);
