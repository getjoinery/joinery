<?php
	...
	if(!$location->get('loc_delete_time')) {
		$options['altlinks'] += array('Edit Location' => '/plugins/event_manager/admin/admin_location_edit?loc_location_id='.$location->key);
	}
	...
	array(
		...
		'breadcrumbs' => array(
			'Locations'=>'/plugins/event_manager/admin/admin_locations',
