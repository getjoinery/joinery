<?php
	...
	require_once(PathHelper::getIncludePath('plugins/event_manager/admin/logic/admin_event_logic.php'));
	...
	array(
		...
		'breadcrumbs' => array(
			'Events'=>'/plugins/event_manager/admin/admin_events',
			$event->get('evt_name') => '',
		),
		'session' => $session,
		'no_page_card' => true,
					...
					<table class="table table-borderless fs-9 fw-medium mb-0">
						<tbody>
							<tr>
								...
								<td class="p-1 text-600">
									...
									<?php if(!$event->get('evt_delete_time') && $_SESSION['permission'] > 7): ?>
										<a href="/plugins/event_manager/admin/admin_event_edit?evt_event_id=<?php echo $event->key; ?>" class="fs-11 ms-2">[edit]</a>
									<?php endif; ?>
								</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td class="p-1 text-600">
									<a href="/plugins/event_manager/admin/admin_location?loc_location_id=<?php echo $event_location->key; ?>">
	...
	<div class="card mb-3">
		<div class="card-header bg-body-tertiary d-flex justify-content-between align-items-center">
			...
			<div>
				<a href="/plugins/event_manager/admin/admin_event_edit?evt_event_id=<?php echo $event->key; ?>" class="btn btn-sm btn-soft-default me-2">Edit Series</a>
				<?php echo AdminPage::action_button('End Series', '/plugins/event_manager/admin/admin_event', [
				...
				<table class="table table-sm table-hover fs-9 mb-0">
					...
					<tbody>
						...
						<tr>
							...
							<td>
								<?php if ($is_cancelled): ?>
									<?php echo AdminPage::action_button('Delete', '/plugins/event_manager/admin/admin_event', [
								...
								<?php elseif ($is_materialized): ?>
									<a href="/plugins/event_manager/admin/admin_event?evt_event_id=<?php echo $mat_instance->key; ?>" class="btn btn-sm btn-soft-default py-0 px-2">View</a>
									<a href="/plugins/event_manager/admin/admin_event_edit?evt_event_id=<?php echo $mat_instance->key; ?>" class="btn btn-sm btn-soft-default py-0 px-2">Edit</a>
									<?php echo AdminPage::action_button('Revert', '/plugins/event_manager/admin/admin_event', [
								...
								<?php else: ?>
									<a href="/plugins/event_manager/admin/admin_event_edit?parent_event_id=<?php echo $event->key; ?>&instance_date=<?php echo $occ_date; ?>" class="btn btn-sm btn-soft-primary py-0 px-2">Edit</a>
									<?php echo AdminPage::action_button('Cancel', '/plugins/event_manager/admin/admin_event', [
	...
	<div class="card mb-3">
		<div class="card-body">
			...
			<a href="/plugins/event_manager/admin/admin_event?evt_event_id=<?php echo $parent_event->key; ?>"><strong><?php echo htmlspecialchars($parent_event->get('evt_name')); ?></strong></a>.
		</div>
	</div>
	<?php
		endif;
	...
	if(!$event->get('evt_delete_time')) {
		if($_SESSION['permission'] >= 8){
			$altlinks +=  array('Create Session' => '/plugins/event_manager/admin/admin_event_session_edit?evt_event_id='.$event->key);
		}
	}
	$box_vars =	array(
		'altlinks' => $altlinks,
	...
	foreach($event_sessions_paged as $event_session){
		...
		// Title with link
		$title_link = '<a href="/plugins/event_manager/admin/admin_event_session_edit?evs_event_session_id='.$event_session->key.'">'
