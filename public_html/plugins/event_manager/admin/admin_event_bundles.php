<?php
	...
	$altlinks = array();
	$altlinks += array('Add Bundle'=> '/plugins/event_manager/admin/admin_event_bundle_edit');
	...
	foreach ($groups as $group){
		...
		array_push($rowvalues, "<a href='/plugins/event_manager/admin/admin_event_bundle?grp_group_id=$group->key'>".$group->get('grp_name')."</a> ");
