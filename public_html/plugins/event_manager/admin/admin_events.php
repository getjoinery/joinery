<?php
	...
	$altlinks = array('New Event'=>'/plugins/event_manager/admin/admin_event_edit');
	...
	foreach ($events as $event){
		...
		$event_name_display = '<a href="/plugins/event_manager/admin/admin_event?evt_event_id='.$event->key.'"><strong>'.$event->get('evt_name'). '</strong></a>';
		...
		if ($numregistrants > 0 || $event->get('evt_max_signups')) {
			...
			$reg_parts[] = '<a href="/plugins/event_manager/admin/admin_event?evt_event_id='.$event->key.'">' . $count_str . ' registered</a>';
		}
