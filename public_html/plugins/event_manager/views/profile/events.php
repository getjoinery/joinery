...
require_once(PathHelper::getThemeFilePath('events_profile_logic.php', 'logic', 'system', null, 'event_manager', false));

$page_vars = process_logic(events_profile_logic(array_merge($_GET, $_POST, $params ?? [])));
