<?php
	...
	require_once(PathHelper::getThemeFilePath('event_sessions_logic.php', 'logic', 'system', null, 'event_manager', false));
...
<section class="jy-content-section">
    <div class="jy-container">
        ...
        <div class="jy-esess-layout">

            <!-- Main content -->
            <div class="jy-esess-main">
                ...
                <div class="jy-panel">
                    <h5 class="jy-esess-loc-title">Location: <?php echo htmlspecialchars($page_vars['location_object']->get('loc_name')); ?></h5>
                    <?php if($page_vars['location_object']->get('loc_address')): ?>
                    <p class="muted jy-esess-mb2">Address: <?php echo htmlspecialchars($page_vars['location_object']->get('loc_address')); ?></p>
                    <?php endif; ?>
                    <?php if($page_vars['location_object']->get('loc_website')): ?>
                    <p class="jy-esess-mb3"><a href="<?php echo htmlspecialchars($page_vars['location_object']->get('loc_website')); ?>"><?php echo htmlspecialchars($page_vars['location_object']->get('loc_website')); ?></a></p>
                    <?php endif; ?>
                    <?php if($page_vars['location_picture']): ?>
                    <img src="<?php echo htmlspecialchars($page_vars['location_picture']); ?>" class="jy-esess-loc-img" alt="">
                    <?php endif; ?>
                ...
                <div class="card">
                    <div class="card-header">
                        <h6 class="jy-tight">Next Session: <?php echo htmlspecialchars($next_name); ?></h6>
                    </div>
                    <div class="card-body">
                        <p class="muted text-sm jy-esess-mb2">&#128197; <?php echo htmlspecialchars($next_time); ?></p>
                        <?php if($next_cal): ?><p class="text-sm jy-esess-mb3"><?php echo $next_cal; ?></p><?php endif; ?>
                ...
                <div class="card">
                    <div class="card-header jy-cardhead-primary">
                        <h5 class="jy-tight jy-white">Sessions</h5>
                    </div>
                    <?php
                    ...
                    ?>
                    <div class="jy-esess-session">
                        <h6 class="jy-esess-session-title"><?php echo htmlspecialchars($session_name); ?></h6>
                        <p class="muted text-sm jy-esess-session-time">&#128197; <?php echo htmlspecialchars($time_string); ?></p>
                        <?php echo $video->get_embed(); ?>
                        <?php if($event_session->get('evs_content')): ?>
                        <div class="jy-mt-3"><?php echo $event_session->get('evs_content'); ?></div>
                        <?php endif; ?>
                        <?php
                        ...
                        ?>
                        <div class="jy-mt-4">
                            <h6 class="text-sm jy-esess-materials-h">Materials:</h6>
                            <ul class="jy-esess-filelist">
                    ...
                    <div class="muted text-sm jy-esess-pager">
                        <?php
            ...
            <!-- Sidebar -->
            <div class="jy-esess-sidebar">
                <?php if($page_vars['event']->get('evt_private_info')): ?>
                <div class="card">
                    <div class="card-header">
                        <h6 class="jy-tight">Registrant Info</h6>
                    </div>
                    <div class="card-body">
