 ...
 * @version 1.45 - the relay job builders are gone (specs/relay_without_a_shell.md WP4): a relay is
 *                 born from first-boot user-data and reached only through its own API; no job
 *                 ever runs on one
 * @version 1.44 - relay provision pre-flight tarred bin/ for the SSH-era relay build
