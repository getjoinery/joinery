		...
		<form method="get" class="row g-2 align-items-end">
			...
			<div class="col-auto">
				...
				<select name="job_type" class="form-select form-select-sm">
					<option value="">All</option>
					<?php foreach (['check_status', 'backup_database', 'backup_project', 'fetch_backup', 'copy_database', 'copy_database_local', 'restore_database', 'restore_project', 'apply_update', 'refresh_archives', 'publish_upgrade'] as $t): ?>
