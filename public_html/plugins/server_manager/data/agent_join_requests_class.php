 ...
 * @version 1.1 - ajr_mgn_managed_node_id deletion action declared: a deleted node clears the pointer and
...
class AgentJoinRequest extends SystemBase {
	...
	public static $pkey_column = 'ajr_agent_join_request_id';
	...
	public static $foreign_key_actions = array(
		'ajr_mgn_managed_node_id' => array('action' => 'null'),
	);

	public static $field_specifications = array(
		'ajr_agent_join_request_id'            => array('type'=>'int8', 'is_nullable'=>false, 'serial'=>true),
