...
class HostedTrial extends SystemBase {
	...
	public static $pkey_column = 'htr_hosted_trial_id';
	...
	protected static $foreign_key_actions = array(
		'htr_cvp_customer_cloud_provision_id' => array('action' => 'cascade'),
	);
	...
	function save($debug = false) {
		if (!$this->get('htr_cvp_customer_cloud_provision_id')) {
...
class MultiHostedTrial extends SystemMultiBase {
	...
	protected function getMultiResults($only_count = false, $debug = false) {
		...
		if (isset($this->options['provision_id'])) {
			$filters['htr_cvp_customer_cloud_provision_id'] = array((int)$this->options['provision_id'], PDO::PARAM_INT);
		}
