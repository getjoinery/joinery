 ...
 */
function inbound_email_retrieve_attachment_bytes(InboundMessageAttachment $att, InboundEmailMessage $message): array {
...
function inbound_email_attachment_safe_filename(string $name): string {
 ...
 */
function inbound_email_stream_attachment(InboundMessageAttachment $att, string $content): void {
	$filename = inbound_email_attachment_safe_filename((string)$att->get('ima_filename'));
