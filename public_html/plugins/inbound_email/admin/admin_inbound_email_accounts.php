...
require_once(PathHelper::getIncludePath('plugins/inbound_email/logic/admin_inbound_email_accounts_logic.php'));

$page_vars = process_logic(admin_inbound_email_accounts_logic(array_merge($_GET, $_POST, $params ?? [])));
extract($page_vars);
...
$domain_base  = '/plugins/inbound_email/admin/admin_inbound_email_domains';
$alias_base   = '/plugins/inbound_email/admin/admin_inbound_email_alias';
$alias_action = '/plugins/inbound_email/admin/admin_inbound_email';
$imap_edit    = '/plugins/inbound_email/admin/admin_inbound_email_imap_edit';
$imap_action  = '/plugins/inbound_email/admin/admin_inbound_email_imap';
