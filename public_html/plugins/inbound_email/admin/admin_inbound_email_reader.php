 ...
 * also used by the member page at /profile/inbound_email/mailbox — this page
...
require_once(PathHelper::getIncludePath('plugins/inbound_email/includes/mailbox_reader_mount.php'));
...
inbound_email_render_mailbox_reader($page, array(
	'csrf_token'          => $csrf_token,
	'initial_mailboxes'   => $initial_mailboxes,
	'attachment_url_base' => '/plugins/inbound_email/admin/admin_inbound_email_attachment',
	'message_detail_base' => '/plugins/inbound_email/admin/admin_inbound_email_message',
));
