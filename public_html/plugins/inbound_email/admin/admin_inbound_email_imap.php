...
require_once(PathHelper::getIncludePath('plugins/inbound_email/logic/admin_inbound_email_imap_logic.php'));

$page_vars = process_logic(admin_inbound_email_imap_logic(array_merge($_GET, $_POST, $params ?? [])));
extract($page_vars);
...
$base = '/plugins/inbound_email/admin/admin_inbound_email_imap';
$edit_base = '/plugins/inbound_email/admin/admin_inbound_email_imap_edit';
