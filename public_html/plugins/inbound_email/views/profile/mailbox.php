<?php
/**
 * Member Mailbox — the Mailbox Reader mounted at /profile/inbound_email/mailbox,
...
require_once(PathHelper::getThemeFilePath('profile_mailbox_logic.php', 'logic', 'system', null, 'inbound_email'));
...
if (!$has_mailboxes) {
	...
	inbound_email_render_mailbox_reader($page, array(
		...
		'attachment_url_base' => '/profile/inbound_email/attachment',
