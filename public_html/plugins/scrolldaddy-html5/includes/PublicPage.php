        ...
        <div class="sidemenu-content">
            ...
            <div class="widget footer-widget">
                ...
                <div class="recent-post-wrap">
                    <div class="recent-post">
                        <div class="media-img">
                            <a href="blog-details.html"><img src="/plugins/scrolldaddy-html5/assets/img/blog/recent-post-1-1.jpg" alt="Blog Image"></a>
                        </div>
                    ...
                    <div class="recent-post">
                        <div class="media-img">
                            <a href="blog-details.html"><img src="/plugins/scrolldaddy-html5/assets/img/blog/recent-post-1-2.jpg" alt="Blog Image"></a>
                        </div>
                        <div class="media-body">
                            <h4 class="post-title"><a class="text-inherit" href="blog-details.html">The Benefits of Managed IT Services post could</a></h4>
                            <div class="recent-post-meta">
                    ...
                    <div class="recent-post">
                        <div class="media-img">
                            <a href="blog-details.html"><img src="/plugins/scrolldaddy-html5/assets/img/blog/recent-post-1-3.jpg" alt="Blog Image"></a>
                        </div>
                        <div class="media-body">
                            <h4 class="post-title"><a class="text-inherit" href="blog-details.html">The Benefits of Managed IT Services post could</a></h4>
                            <div class="recent-post-meta">
            ...
            <div class="widget footer-widget">
                ...
                <div class="th-widget-contact">
                    <div class="info-box">
                        <div class="box-icon">
                            <img src="/plugins/scrolldaddy-html5/assets/img/icon/location.svg" alt="">
                        </div>
                        <p class="box-text">55 Main Street, 2nd block Malborne, Australia</p>
                    </div>
                    <div class="info-box">
                        <div class="box-icon">
                            <img src="/plugins/scrolldaddy-html5/assets/img/icon/mail.svg" alt="">
                        </div>
                        <p class="box-text">
                    ...
                    <div class="info-box">
                        <div class="box-icon">
                            <img src="/plugins/scrolldaddy-html5/assets/img/icon/call.svg" alt="">
                        </div>
                        <p class="box-text">
