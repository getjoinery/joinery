<?php
/**
 * Remove a coupon code from the current shopping cart (checkout page JS).
...
function checkout_remove_coupon_logic(array $input): LogicResult {
...
function checkout_remove_coupon_logic_descriptor(): array {
	return [
		'description'      => 'Remove a coupon code from the current shopping cart.',
