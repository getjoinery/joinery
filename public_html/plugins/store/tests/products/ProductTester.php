...
class ProductTester {
    ...
    private function createProductVersion($product_id, $version_spec) {
        ...
        try {
            ...
            require_once(PathHelper::getRootDir() . '/plugins/store/data/product_versions_class.php');
    ...
    private function addProductToCart($product_id, $product_spec) {
        ...
        try {
            ...
            require_once(PathHelper::getRootDir() . '/plugins/store/logic/product_logic.php');
    ...
    private function processPaymentByMode($mode) {
        ...
        if ($mode === 'stripe_checkout') {
            ...
            try {
                require_once(PathHelper::getRootDir() . '/plugins/store/logic/cart_charge_logic.php');
