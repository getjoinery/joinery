...
require_once(PathHelper::getIncludePath('plugins/store/admin/logic/admin_coupon_codes_logic.php'));
...
$altlinks = array('New Coupon Code'=>'/plugins/store/admin/admin_coupon_code_edit');
