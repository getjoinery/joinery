<?php
	...
	require_once(PathHelper::getIncludePath('plugins/store/admin/logic/admin_product_logic.php'));
				...
				<div class="card-body">
					<table class="table table-borderless fs-9 fw-medium mb-0">
						<tbody>
							...
							<?php if($fulfillment_display): ?>
							<tr>
								<td class="p-1" style="width: 35%;">Purchase grants:</td>
								<td class="p-1 text-600">
									<?php echo $fulfillment_display; ?>
								</td>
							</tr>
							<?php endif; ?>
		...
		<div class="col-xxl-6">
			...
			<div class="card">
				<div class="card-header bg-body-tertiary d-flex justify-content-between align-items-center">
					...
					<a href="/plugins/store/admin/admin_product_version_edit?product_id=<?php echo $product->key; ?>" class="btn btn-sm btn-soft-default">
