<?php
	...
	// read_customer_id resolves the mode-appropriate id from stc_stripe_customers.
	$methods = $stripe_helper->get_payment_methods($stripe_helper->read_customer_id($user));
