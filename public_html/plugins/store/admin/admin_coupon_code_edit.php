<?php
	...
	require_once(PathHelper::getIncludePath('plugins/store/admin/logic/admin_coupon_code_edit_logic.php'));

	$page_vars = process_logic(admin_coupon_code_edit_logic(array_merge($_GET, $_POST)));
	extract($page_vars);
