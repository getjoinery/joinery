...
require_once(PathHelper::getIncludePath('plugins/store/admin/logic/admin_yearly_report_donations_logic.php'));
...
$formwriter = $page->getFormWriter('form1', [
	'method' => 'GET',
	'action' => '/plugins/store/admin/admin_yearly_report_donations'
]);
