...
require_once(PathHelper::getThemeFilePath('device_soft_delete_logic.php', 'logic', 'system', null, 'dns_filtering'));

$page_vars = process_logic(device_soft_delete_logic(array_merge($_GET, $_POST, $params ?? [])));
