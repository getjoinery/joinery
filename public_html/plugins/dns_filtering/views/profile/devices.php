			...
			echo '
						...
						<div class="job-post style2">
							...
							<div class="job-post_author">
								...
								<a class="th-btn style5" href="/profile/dns_filtering/scheduled_block_edit?device_id='.$device->key.'&block_id='.$always_on_block_ids[$device->key].'">Edit</a>
							</div>';
			...
			echo '
						...
						<div class="job-post style2">
							...
							<div class="job-post_author">
								...
								<a class="th-btn style5" href="/profile/dns_filtering/activation?device_id='.$device->key.'">Activate</a>
							</div>
						...
						<div class="job-post style2">
							<div class="job-content">
								<div class="job-post_date">
									...
									<a class="th-btn style5" href="/profile/dns_filtering/device_edit">Add</a>
								</div>
							</div>
