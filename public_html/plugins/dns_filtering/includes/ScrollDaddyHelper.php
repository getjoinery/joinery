...
class ScrollDaddyHelper {
	...
	public static function exportDevice($device, $settings) {
		...
		return array(
			...
			'allow_device_edits' => (bool)$device->get('sdd_allow_device_edits'),
			'filters_editable' => (bool)$device->are_filters_editable(),
			'create_time' => LibraryFunctions::api_timestamp($device->get('sdd_create_time')),
			'activate_time' => LibraryFunctions::api_timestamp($device->get('sdd_activate_time')),
