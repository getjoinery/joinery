...
// ── Daily ──────────────────────────────────────────────────────────────────
ok('daily interval 1: 5th from Jul 1 = Jul 5',
      nth('2026-07-01', 5, ['type' => 'daily']) === '2026-07-05');
ok('daily interval 3: 4th from Jul 1 = Jul 10',
      nth('2026-07-01', 4, ['type' => 'daily', 'interval' => 3]) === '2026-07-10');
ok('count 1 returns the anchor itself',
      nth('2026-07-01', 1, ['type' => 'daily']) === '2026-07-01');

// ── Weekly ───────────────────────────────────────────────────────────────────
ok('weekly Mon+Wed: 4th from Mon Jul 6 = Wed Jul 15',
      nth('2026-07-06', 4, ['type' => 'weekly', 'days' => '1,3']) === '2026-07-15');
ok('weekly interval 2 (anchor DOW): 3rd from Mon Jul 6 = Mon Aug 3',
      nth('2026-07-06', 3, ['type' => 'weekly', 'interval' => 2]) === '2026-08-03');

// ── Monthly by day-of-month ──────────────────────────────────────────────────
ok('monthly 15th: 3rd from Jan 15 = Mar 15',
      nth('2026-01-15', 3, ['type' => 'monthly']) === '2026-03-15');
ok('monthly 31st skips short months: 3rd from Jan 31 = May 31',
      nth('2026-01-31', 3, ['type' => 'monthly']) === '2026-05-31');

// ── Monthly by weekday ───────────────────────────────────────────────────────
ok('monthly 2nd Tuesday: 3rd from Jul 14 = Sep 8',
      nth('2026-07-14', 3, ['type' => 'monthly', 'week' => 2, 'days' => '2']) === '2026-09-08');
ok('monthly last Sunday: 1st from May 31 = May 31',
      nth('2026-05-31', 1, ['type' => 'monthly', 'week' => -1, 'days' => '0']) === '2026-05-31');

// ── Yearly ───────────────────────────────────────────────────────────────────
ok('yearly: 3rd from Mar 10 2026 = Mar 10 2028',
      nth('2026-03-10', 3, ['type' => 'yearly']) === '2028-03-10');
ok('yearly Feb 29 lands only on leap years: 2nd from 2024-02-29 = 2028-02-29',
      nth('2024-02-29', 2, ['type' => 'yearly']) === '2028-02-29');

// ── Guards ───────────────────────────────────────────────────────────────────
ok('count 0 returns null', nth('2026-07-01', 0, ['type' => 'daily']) === null);
$plain = new CalendarEntry(NULL);
$plain->set('cal_start_local', '2026-07-01 00:00:00');
ok('non-recurring entry returns null', $plain->nth_occurrence_date('2026-07-01', 3) === null);
