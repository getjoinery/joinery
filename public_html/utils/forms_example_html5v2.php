<?php
/**
 * FormWriter v2 HTML5 Test & Example File
 *
...
$hoptions = array(
    'is_valid_page' => true,
    'title' => 'FormWriter v2 HTML5 Test - All Features'
);
...
echo PublicPage::BeginPage('FormWriter v2 HTML5 Test - Complete Feature Demonstration');

// Load FormWriter v2 HTML5
...
$formwriter1 = new FormWriterV2HTML5('values_demo_form', [
    'action' => '/test/submit',
    'method' => 'POST',
...
$formwriter2 = new FormWriterV2HTML5('auto_validation_form', [
...
$formwriter3 = new FormWriterV2HTML5('all_fields_form', [
...
$formwriter4 = new FormWriterV2HTML5('validation_types_form', [
    'action' => '/test/types',
    'method' => 'POST',
    'debug' => true
]);
...
$formwriter5 = new FormWriterV2HTML5('csrf_demo_form', [
    'action' => '/test/csrf',
...
if ($_SERVER[\'REQUEST_METHOD\'] === \'POST\') {
    $formwriter = new FormWriterV2HTML5(\'form_id\', $_POST);
...
echo 'All existing code continues to work unchanged. Use FormWriterV2HTML5 directly for new forms.';
echo '</div>';
