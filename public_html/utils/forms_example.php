<?php
	...
	require_once(LibraryFunctions::get_theme_path().'/includes/FormWriterPublic-tw.php');
	...
	echo $formwriter->textinput('Coupon code', 'ccd_code', NULL, 100, NULL, '', 255, '');	
	
	echo $formwriter->textinput('Website', 'website', NULL, 100, NULL, '', 255, '', '', 'www.text.com/');	
	
	$optionvals = array("Inactive"=>0, "Active"=>1);
	echo $formwriter->dropinput("Active?", "ccd_is_active", "", $optionvals, NULL, '', TRUE);
...
<fieldset><legend class="text-base font-medium text-gray-900">Valid products for this code</label><div id="products_list_container" class="mt-4 space-y-4 errorplacement"><div class="relative flex items-start">
<div class="flex items-center h-5">
									<input class="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300 rounded" type="checkbox" id="products_list47" name="products_list[]" value="47"   />
								</div>
								<div class="ml-3 text-sm">
									<label class="font-medium text-gray-700" for="products_list47">Integral Zen 7 Day Retreat (Arizona)</label>      
								</div>
						</div>
					   <div class="relative flex items-start">
								<div class="flex items-center h-5">
									<input class="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300 rounded" type="checkbox" id="products_list46" name="products_list[]" value="46"   />
								</div>
								<div class="ml-3 text-sm">
									<label class="font-medium text-gray-700" for="products_list46">Integral Zen 7 Day Retreat (New Hampshire)</label>      
								</div>
						</div>
					   <div class="relative flex items-start">
								<div class="flex items-center h-5">
									<input class="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300 rounded" type="checkbox" id="products_list45" name="products_list[]" value="45"   />
								</div>
								<div class="ml-3 text-sm">
									<label class="font-medium text-gray-700" for="products_list45">Integral Zen 7 Day Retreat, Yokoji Zen Mountain Center</label>      
								</div>
						</div>

					   <div class="relative flex items-start">
								<div class="flex items-center h-5">
									<input class="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300 rounded" type="checkbox" id="products_list2" name="products_list[]" value="2"   />
								</div>
								<div class="ml-3 text-sm">
									<label class="font-medium text-gray-700" for="products_list2">One-time Donation</label>      
								</div>
						</div>
					   </div></fieldset>
