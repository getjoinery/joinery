			...
			if($settings->get_setting('checkout_type') == 'stripe_checkout'){					
				...
				function ToCheckout() {
					stripe.redirectToCheckout({
					  sessionId: '<?php echo $page_vars['stripe_session']->id; ?>'
				...
				echo $formwriter->begin_form("mt-6", "post", '/profile/payment_finalize');

				echo '<div id="errorMsg" style="display:none;"></div>';

				echo $formwriter->hiddeninput('cc_type', '');
				...
				<script src="https://js.stripe.com/v3/"></script>
				<h2 class="text-lg font-medium text-gray-900">Credit or Debit Card</h5>
				...
				echo $formwriter->new_form_button('Submit Payment', 'primary', 'full'); 
				?>
