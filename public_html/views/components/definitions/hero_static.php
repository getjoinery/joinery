<?php
/**
 * Hero Static Component Definition
 *
...
return [
	...
	'config_schema' => [
		'fields' => [
			...
			['name' => 'cta_style', 'label' => 'Button Style', 'type' => 'dropinput', 'options' => ['primary' => 'Primary', 'secondary' => 'Secondary', 'outline-primary' => 'Outline', 'light' => 'Light']],
		]
	],
	'logic_function' => null,
