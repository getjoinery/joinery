<?php
	...
	if($cart->items){
		...
		throw new SystemDisplayablePermanentError("The cart has already been cleared or you have cookies turned off.  Please try turning cookies on in your browser.");
		exit();				
	}
