...
class FormWriterBootstrap extends FormWriterBase {
	...
	/**
	 * Override multi_upload_button for Bootstrap styling
	 */
	protected function multi_upload_button($context, $id, $label, $disabled = false) {
		...
		switch($context) {
			case 'browse':
				$style_class = 'btn btn-outline-primary';
				break;
			case 'upload':
				$style_class = 'btn btn-primary';
				break;
			case 'clear':
				$style_class = 'btn btn-outline-secondary ms-2';
				break;
			default:
				$style_class = 'btn btn-secondary';
		}
