...
class Login2fa {
	...
	/**
	 * Complete a pending 2FA login for a verified user: establish the session,
	 * honor the remember-me choice, refresh the trusted-device cookie (a no-op for
	 * accounts without TOTP), clear the pending state, and return the post-login
	 * redirect target.
	 */
	public static function completePendingLogin(User $user): string {
