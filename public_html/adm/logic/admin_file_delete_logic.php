 ...
 * @return LogicResult
 */
function admin_file_delete_logic(array $input): LogicResult {
	...
	if (!empty($input['confirm'])) {
		$fil_file_id = LibraryFunctions::fetch_variable('fil_file_id', NULL, 1, 'You must provide a file to delete.', $input);
