<?php
	...
	$formwriter->dropinput('pst_tier_min_level', 'Minimum Tier Required', [
		'options' => $tier_options,
		'helptext' => 'Restrict this post to users with this subscription tier or higher'
	]);
	...
	$formwriter->dropinput('pst_tier_public_after_hours', 'Make public after', [
