...
class Order extends SystemBase {
	...
	public static $fields = array(
		...
		'ord_stripe_customer_id' => 'Stripe customer id',
		...
		'ord_stripe_subscription_id' => 'Subscription id if it is a subscription',
	...
	static function InitDB($mode='structure'){
		...
		$sql = '
			CREATE TABLE IF NOT EXISTS "public"."ord_orders" (
			  ...
			  "ord_stripe_customer_id" varchar(30) COLLATE "pg_catalog"."default",
			  "ord_stripe_payment_intent_id" varchar(32) COLLATE "pg_catalog"."default",
			  "ord_stripe_subscription_id" varchar(32) COLLATE "pg_catalog"."default",
