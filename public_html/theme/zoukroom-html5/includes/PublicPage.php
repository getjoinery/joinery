	...
	<div class="uk-container uk-text-muted">
		<div class="uk-child-width-1-2@s uk-child-width-1-5@m" data-uk-grid>
			...
			<div>
				...
				<ul class="uk-list uk-text-small">
					<li><p>Send an email to <a href="mailto:jeremy.tunnell@gmail.com">jeremy.tunnell@gmail.com</a> with the course dates, description, link to register, a large picture for the event, and a large picture of your instructor.</p></li>
				</ul>
			</div>
			<div>
				<h5>&nbsp;</h5>
