...
<html lang="en" class="no-js">
    <head>
        ...
        <!-- Favicon-->
        <link rel="shortcut icon" href="/theme/empoweredhealth-html5/assets/img/favicons/favicon.ico">
        <link rel="icon" type="image/png" href="/theme/empoweredhealth-html5/assets/img/favicons/favicon.ico">
        <link rel="apple-touch-icon-precomposed" sizes="144x144" href="/theme/empoweredhealth-html5/assets/img/favicons/apple-icon-144x144.png">
        <link rel="apple-touch-icon-precomposed" sizes="114x114" href="/theme/empoweredhealth-html5/assets/img/favicons/apple-icon-114x114.png">
        ...
        <link rel="stylesheet" href="/theme/empoweredhealth-html5/assets/css/empoweredhealth.min.css">
                ...
                <div class="row align-items-center justify-content-between d-flex">
                  <div id="logo">
                    <a href="/">
                        ...
                        <?php else: ?>
                            <img src="/theme/empoweredhealth-html5/assets/img/logo-transp.png" alt="<?php echo htmlspecialchars($site_name); ?>" title="<?php echo htmlspecialchars($site_name); ?>">
                        <?php endif; ?>
                    </a>
                  </div>
                  <nav id="nav-menu-container">
                    <ul class="nav-menu">
                      <?php foreach ($menus as $menu): ?>
                          <li class="<?php echo (isset($menu['is_active']) && $menu['is_active']) ? 'menu-active' : ''; ?><?php echo (isset($menu['submenu']) && !empty($menu['submenu'])) ? ' menu-has-children' : ''; ?>">
