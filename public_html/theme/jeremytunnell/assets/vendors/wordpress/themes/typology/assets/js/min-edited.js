...
function(t) {
    ...
    var p, s, d, o, u, e, l = "Close",
        ...
        b = function(t, e) {
            p.ev.triggerHandler(i + t, e), p.st.callbacks && (t = t.charAt(0).toLowerCase() + t.slice(1), p.st.callbacks[t] && p.st.callbacks[t].apply(p, h.isArray(e) ? e : [e]))
        },
        x = function(t) {
    ...
    t.prototype = {
        ...
        init: function() {
            ...
            p.isIE7 = -1 !== t.indexOf("MSIE 7."), p.isIE8 = -1 !== t.indexOf("MSIE 8."), p.isLowIE = p.isIE7 || p.isIE8, p.isAndroid = /android/gi.test(t), p.isIOS = /iphone|ipad|ipod/gi.test(t), p.supportsTransition = function() {
                ...
                return !1
            }(), p.probablyMobile = p.isAndroid || p.isIOS || /(Opera Mini)|Kindle|webOS|BlackBerry|(Opera Mobi)|(Windows Phone)|IEMobile/i.test(navigator.userAgent), d = h(document), p.popupsCache = {}
        },
        open: function(t) {
            var e;
            if (!1 === t.isObj) {
            ...
            if (!p.isOpen) {
                p.types = [], u = "", t.mainEl && t.mainEl.length ? p.ev = t.mainEl.eq(0) : p.ev = d, t.key ? (p.popupsCache[t.key] || (p.popupsCache[t.key] = {}), p.currTemplate = p.popupsCache[t.key]) : p.currTemplate = {}, p.st = h.extend(!0, {}, h.magnificPopup.defaults, t), p.fixedContentPos = "auto" === p.st.fixedContentPos ? !p.probablyMobile : p.st.fixedContentPos, p.st.modal && (p.st.closeOnContentClick = !1, p.st.closeOnBgClick = !1, p.st.showCloseBtn = !1, p.st.enableEscapeKey = !1), p.bgOverlay || (p.bgOverlay = _("bg").on("click" + m, function() {
                    p.close()
                }), p.wrap = _("wrap").attr("tabindex", -1).on("click" + m, function(t) {
                ...
                b("BeforeOpen"), p.st.showCloseBtn && (p.st.closeBtnInside ? (w(A, function(t, e, i, s) {
                    i.close_replaceWith = x(s.type)
                }), u += " mfp-close-btn-in") : p.wrap.append(x())), p.st.alignTop && (u += " mfp-align-top"), p.fixedContentPos ? p.wrap.css({
                    ...
                    height: d.height(),
                    position: "absolute"
                }), p.st.enableEscapeKey && d.on("keyup" + m, function(t) {
                    27 === t.keyCode && p.close()
                }), v.on("resize" + m, function() {
                    p.updateSize()
                ...
                p.fixedContentPos && (p.isIE7 ? h("body, html").css("overflow", "hidden") : a.overflow = "hidden");
                var c = p.st.mainClass;
                return p.isIE7 && (c += " mfp-ie7"), c && p._addClassToMFP(c), p.updateItemHTML(), b("BuildControls"), h("html").css(a), p.bgOverlay.add(p.wrap).prependTo(p.st.prependTo || h(document.body)), p._lastFocusedEl = document.activeElement, setTimeout(function() {
                    p.content ? (p._addClassToMFP(f), p._setFocus()) : p.bgOverlay.addClass(f), d.on("focusin" + m, p._onFocusIn)
                }, 16), p.isOpen = !0, p.updateSize(r), b(g), t
            }
            p.updateItemHTML()
        },
        close: function() {
            p.isOpen && (b(c), p.isOpen = !1, p.st.removalDelay && !p.isLowIE && p.supportsTransition ? (p._addClassToMFP(n), setTimeout(function() {
                p._close()
        ...
        updateItemHTML: function() {
            ...
            if (b("BeforeChange", [p.currItem ? p.currItem.type : "", e]), p.currItem = t, !p.currTemplate[e]) {
                ...
                b("FirstMarkupParse", i), p.currTemplate[e] = !i || h(i)
            }
            o && o !== t.type && p.container.removeClass("mfp-" + o + "-holder");
            var s = p["get" + e.charAt(0).toUpperCase() + e.slice(1)](t, p.currTemplate[e]);
            p.appendContent(s, e), t.preloaded = !0, b(r, t), o = t.type, p.container.prepend(p.contentContainer), b("AfterChange")
        },
        appendContent: function(t, e) {
            (p.content = t) ? p.st.showCloseBtn && p.st.closeBtnInside && !0 === p.currTemplate[e] ? p.content.find(".mfp-close").length || p.content.append(x()) : p.content = t: p.content = "", b("BeforeAppend"), p.container.addClass("mfp-" + e + "-holder"), p.contentContainer.append(p.content)
        },
        parseEl: function(t) {
            var e, i = p.items[t];
            if ((i = i.tagName ? {
                ...
                for (var s = p.types, o = 0; o < s.length; o++)
            ...
            return i.type = e || p.st.type || "inline", i.index = t, i.parsed = !0, p.items[t] = i, b("ElementParse", i), p.items[t]
        },
        ...
        updateStatus: function(t, e) {
            if (p.preloader) {
                s !== t && p.container.removeClass("mfp-s-" + s), e || "loading" !== t || (e = p.st.tLoading);
                var i = {
                    status: t,
                    text: e
                };
        ...
        _hasScrollBar: function(t) {
            return (p.isIE7 ? d.height() : document.body.scrollHeight) > (t || v.height())
        },
        _setFocus: function() {
        ...
        _parseMarkup: function(o, t, e) {
            var n;
            e.data && (t = h.extend(e.data, t)), b(A, [o, t, e]), h.each(t, function(t, e) {
        ...
        modules: [],
        open: function(t, e) {
            return C(), (t = t ? h.extend(!0, {}, t) : {}).isObj = !0, t.index = e || 0, this.instance.open(t)
        },
        close: function() {
        ...
        if ("string" == typeof t)
            if ("open" === t) {
                ...
                i = s.items ? s.items[o] : (i = e, s.delegate && (i = i.find(s.delegate)), i.eq(o)), p._openClick({
                    mfpEl: i
                }, e, s)
            } else p.isOpen && p[t].apply(p, Array.prototype.slice.call(arguments, 1));
        else t = h.extend(!0, {}, t), y ? e.data("magnificPopup", t) : e[0].magnificPopup = t, p.addGroup(e, t);
        return e
    };
    var T, k, E, B = "inline",
        z = function() {
    ...
    h.magnificPopup.registerModule(B, {
        options: {
            hiddenClass: "hide",
            markup: "",
            ...
            getInline: function(t, e) {
                if (z(), t.src) {
                    ...
                    if (s.length) {
                        ...
                        o && o.tagName && (k || (T = i.hiddenClass, k = _(T), T = "mfp-" + T), E = s.after(k).detach().removeClass(T)), p.updateStatus("ready")
                    } else p.updateStatus("error", i.tNotFound), s = h("<div>");
    ...
    h.magnificPopup.registerModule(M, {
        ...
        proto: {
            initAjax: function() {
                p.types.push(M), I = p.st.ajax.cursor, w(l + "." + M, P), w("BeforeChange." + M, P)
            },
            getAjax: function(o) {
                I && h(document.body).addClass(I), p.updateStatus("loading");
                var t = h.extend({
                    url: o.src,
                    success: function(t, e, i) {
                        ...
                        b("ParseAjax", s), p.appendContent(h(s.data), M), o.finished = !0, S(), p._setFocus(), setTimeout(function() {
                            p.wrap.addClass(f)
                        }, 16), p.updateStatus("ready"), b("AjaxContentAdded")
                    },
                    error: function() {
                        S(), o.finished = o.loadError = !0, p.updateStatus("error", p.st.ajax.tError.replace("%url%", o.src))
                    }
                }, p.st.ajax.settings);
    ...
    h.magnificPopup.registerModule("image", {
        ...
        proto: {
            initImage: function() {
                var t = p.st.image,
                    e = ".image";
                p.types.push("image"), w(g + e, function() {
                    "image" === p.currItem.type && t.cursor && h(document.body).addClass(t.cursor)
                }), w(l + e, function() {
                    t.cursor && h(document.body).removeClass(t.cursor), v.off("resize" + m)
            ...
            _onImageHasSize: function(t) {
                t.img && (t.hasSize = !0, D && clearInterval(D), t.isCheckingImgSize = !1, b("ImageHasSize", t), t.imgHidden && (p.content && p.content.removeClass("mfp-loading"), t.imgHidden = !1))
            },
                ...
                var i = 0,
                    ...
                    o = function(t) {
                        D && clearInterval(D), D = setInterval(function() {
                            0 < s.naturalWidth ? p._onImageHasSize(e) : (200 < i && clearInterval(D), 3 === ++i ? o(10) : 40 === i ? o(50) : 100 === i && o(500))
                        }, t)
                    };
                o(1)
            },
            getImage: function(t, e) {
                var i = 0,
                    s = function() {
                        t && (t.img[0].complete ? (t.img.off(".mfploader"), t === p.currItem && (p._onImageHasSize(t), p.updateStatus("ready")), t.hasSize = !0, t.loaded = !0, b("ImageLoadComplete")) : ++i < 200 ? setTimeout(s, 100) : o())
                    },
                    o = function() {
                        t && (t.img.off(".mfploader"), t === p.currItem && (p._onImageHasSize(t), p.updateStatus("error", n.tError.replace("%url%", t.src))), t.hasSize = !0, t.loaded = !0, t.loadError = !0)
                    },
                    n = p.st.image,
                    r = e.find(".mfp-img");
                if (r.length) {
                    var a = document.createElement("img");
                    a.className = "mfp-img", t.el && t.el.find("img").length && (a.alt = t.el.find("img").attr("alt")), t.img = h(a).on("load.mfploader", s).on("error.mfploader", o), a.src = t.src, r.is("img") && (t.img = t.img.clone()), 0 < (a = t.img[0]).naturalWidth ? t.hasSize = !0 : a.width || (t.hasSize = !1)
                }
                ...
                }, t), p.resizeImage(), t.hasSize ? (D && clearInterval(D), t.loadError ? (e.addClass("mfp-loading"), p.updateStatus("error", n.tError.replace("%url%", t.src))) : (e.removeClass("mfp-loading"), p.updateStatus("ready"))) : (p.updateStatus("loading"), t.loading = !0, t.hasSize || (t.imgHidden = !0, e.addClass("mfp-loading"), p.findImageSize(t))), e
            }
        }
    });
    var $;
    h.magnificPopup.registerModule("zoom", {
        ...
        proto: {
                ...
                if (n.enabled && p.supportsTransition) {
                    ...
                    w("BuildControls" + e, function() {
                        if (p._allowZoom()) {
                            ...
                            (s = r(t)).css(p._getOffset()), p.wrap.append(s), i = setTimeout(function() {
                                s.css(p._getOffset(!0)), i = setTimeout(function() {
                        ...
                        if (p._allowZoom()) {
                            if (clearTimeout(i), p.st.removalDelay = o, !t) {
                                if (!(t = p._getItemToZoom())) return;
                                s = r(t)
                            }
                            s.css(p._getOffset(!0)), p.wrap.append(s), p.content.css("visibility", "hidden"), setTimeout(function() {
                                s.css(p._getOffset())
                            }, 16)
                        }
                    }), w(l + e, function() {
                        p._allowZoom() && (a(), s && s.remove(), t = null)
                    })
                }
            },
            _allowZoom: function() {
            ...
            _getOffset: function(t) {
                ...
                var n = {
                    width: e.width(),
                    height: (y ? e.innerHeight() : e[0].offsetHeight) - o - s
                };
    ...
    h.magnificPopup.registerModule(H, {
        ...
        proto: {
            initIframe: function() {
                p.types.push(H), w("BeforeChange", function(t, e, i) {
                    e !== i && (e === H ? O() : i === H && O(!0))
                }), w(l + "." + H, function() {
                    O()
                })
            ...
            getIframe: function(t, e) {
                ...
                var o = {};
                return s.srcAction && (o[s.srcAction] = i), p._parseMarkup(e, o, t), p.updateStatus("ready"), e
            }
        }
    });
    var j = function(t) {
        ...
        proto: {
            initGallery: function() {
                ...
                u += " mfp-gallery", w(g + t, function() {
                    ...
                    e.text && (e.text = W(e.text, p.currItem.index, p.items.length))
                }), w(A + t, function(t, e, i, s) {
                    ...
                    if (1 < p.items.length && n.arrows && !p.arrowLeft) {
                        var t = n.arrowMarkup,
                            e = p.arrowLeft = h(t.replace(/%title%/gi, n.tPrev).replace(/%dir%/gi, "left")).addClass(a),
                            i = p.arrowRight = h(t.replace(/%title%/gi, n.tNext).replace(/%dir%/gi, "right")).addClass(a),
                            s = o ? "mfpFastClick" : "click";
                        e[s](function() {
                            p.prev()
                        }), i[s](function() {
                            p.next()
                        }), p.isIE7 && (_("b", e[0], !1, !0), _("a", e[0], !1, !0), _("b", i[0], !1, !0), _("a", i[0], !1, !0)), p.container.append(e.add(i))
                    }
                }), w(r + t, function() {
                    ...
                    d.off(t), p.wrap.off("click" + t), p.arrowLeft && o && p.arrowLeft.add(p.arrowRight).destroyMfpFastClick(), p.arrowRight = p.arrowLeft = null
                })
            },
            next: function() {
            ...
            preloadNearbyImages: function() {
                var t, e = p.st.gallery.preload,
                    ...
                    s = Math.min(e[1], p.items.length);
                for (t = 1; t <= (p.direction ? s : i); t++) p._preloadItem(p.index + t);
                for (t = 1; t <= (p.direction ? i : s); t++) p._preloadItem(p.index - t)
            },
            _preloadItem: function(t) {
                if (t = j(t), !p.items[t].preloaded) {
                    var e = p.items[t];
                    e.parsed || (e = p.parseEl(t)), b("LazyLoad", e), "image" === e.type && (e.img = h('<img class="mfp-img" />').on("load.mfploader", function() {
                        e.hasSize = !0
    ...
    var F, Z, L, Q = "retina";
    h.magnificPopup.registerModule(Q, {
        options: {
        ...
        proto: {
            initRetina: function() {
                if (1 < window.devicePixelRatio) {
                    var i = p.st.retina,
                        s = i.ratio;
                    1 < (s = isNaN(s) ? s() : s) && (w("ImageHasSize." + Q, function(t, e) {
                        e.img.css({
    ...
    }), F = "ontouchstart" in window, Z = function() {
        v.off("touchmove" + L + " touchend" + L)
    }, L = ".mfpFastClick", h.fn.mfpFastClick = function(l) {
        return h(this).each(function() {
            var e, i, s, o, n, r, a, t = h(this);
            F && t.on("touchstart" + L, function(t) {
                n = !1, a = 1, r = t.originalEvent ? t.originalEvent.touches[0] : t.touches[0], s = r.clientX, o = r.clientY, v.on("touchmove" + L, function(t) {
                    r = t.originalEvent ? t.originalEvent.touches : t.touches, a = r.length, r = r[0], (10 < Math.abs(r.clientX - s) || 10 < Math.abs(r.clientY - o)) && (n = !0, Z())
                }).on("touchend" + L, function(t) {
                    Z(), n || 1 < a || (e = !0, t.preventDefault(), clearTimeout(i), i = setTimeout(function() {
                        e = !1
                    }, 1e3), l())
                })
        ...
        h(this).off("touchstart" + L + " click" + L), F && v.off("touchmove" + L + " touchend" + L)
    }, C()
}),
function(l, i, o, n) {
    function c(t, e) {
    ...
    c.Defaults = {
        ...
        l(o).off(".owl.core"), this.$element.removeClass(this.options.grabClass), (0 !== e.x && this.is("dragging") || !this.is("valid")) && (this.speed(this.settings.dragEndSpeed || this.settings.smartSpeed), this.current(this.closest(i.x, 0 !== e.x ? s : this._drag.direction)), this.invalidate("position"), this.update(), this._drag.direction = s, (3 < Math.abs(e.x) || 300 < (new Date).getTime() - this._drag.time) && this._drag.target.one("click.owl.core", function() {
            return !1
        ...
        return this.settings.freeDrag || l.each(r, l.proxy(function(t, e) {
            return "left" === s && e - 30 < i && i < e + 30 ? o = t : "right" === s && e - n - 30 < i && i < e - n + 30 ? o = t + 1 : this.op(i, "<", e) && this.op(i, ">", r[t + 1] || e - n) && (o = "left" === s ? t + 1 : t), -1 === o
        ...
        var i = this.current(),
            ...
            a = this.minimum(),
            l = this.maximum();
        this.settings.loop ? (!this.settings.rewind && Math.abs(o) > r / 2 && (o += -1 * n * r), (s = (((t = i + o) - a) % r + r) % r + a) !== t && s - o <= l && 0 < s - o && (i = s - o, t = s, this.reset(i))) : t = this.settings.rewind ? (t % (l += 1) + l) % l : Math.max(a, Math.min(l, t)), this.speed(this.duration(i, t, e)), this.current(t), this.$element.is(":visible") && this.update()
        ...
        e = e === n ? this._items.length : this.normalize(e, !0), t = t instanceof jQuery ? t : l(t), this.trigger("add", {
            content: t,
            position: e
        ...
        this._core = t, this._loaded = [], this._handlers = {
            "initialized.owl.carousel change.owl.carousel resized.owl.carousel": a.proxy(function(t) {
                if (t.namespace && this._core.settings && this._core.settings.lazyLoad && (t.property && "position" == t.property.name || "initialized" == t.type))
                    for (var e = this._core.settings, i = e.center && Math.ceil(e.items / 2) || e.items, s = e.center && -1 * i || 0, o = (t.property && void 0 !== t.property.value ? t.property.value : this._core.current()) + s, n = this._core.clones().length, r = a.proxy(function(t, e) {
                            this.load(e)
                        }, this); s++ < i;) this.load(n / 2 + this._core.relative(o)), n && a.each(this._core.clones(this._core.relative(o)), r), o++
            }, this)
...
function(h, t, e, i) {
    var s = function(t) {
        ...
        }, this._core.options = h.extend({}, s.Defaults, this._core.options), this._core.$element.on(this._handlers), this._core.$element.on("click.owl.video", ".owl-video-play-icon", h.proxy(function(t) {
            this.play(t)
        }, this))
    };
    s.Defaults = {
        ...
        return e.wrap('<div class="owl-video-wrapper"' + o + "></div>"), this._core.settings.lazyLoad && (r = "data-src", a = "owl-lazy"), n.length ? (c(n.attr(r)), n.remove(), !1) : void("youtube" === t.type ? (s = "//img.youtube.com/vi/" + t.id + "/hqdefault.jpg", c(s)) : "vimeo" === t.type ? h.ajax({
            type: "GET",
...
function(r, t, e, i) {
    ...
    s.Defaults = {
        ...
        if (1 === this.core.settings.items && r.support.animation && r.support.transition) {
            ...
            this.core.current() !== this.previous && (n && (t = this.core.coordinates(this.previous) - this.core.coordinates(this.next), i.one(r.support.animation.end, e).css({
                left: t + "px"
...
function(n, t, e, i) {
    ...
    s.Defaults = {
        ...
        var t, e = this._core.settings,
            ...
            o = e.loop || e.rewind;
        this._controls.$relative.toggleClass("disabled", !e.nav || i), e.nav && (this._controls.$previous.toggleClass("disabled", !o && s <= this._core.minimum(!0)), this._controls.$next.toggleClass("disabled", !o && s >= this._core.maximum(!0))), this._controls.$absolute.toggleClass("disabled", !e.dots || i), e.dots && (t = this._pages.length - this._controls.$absolute.children().length, e.dotsData && 0 !== t ? this._controls.$absolute.html(this._templates.join("")) : 0 < t ? this._controls.$absolute.append(new Array(t + 1).join(this._templates[0])) : t < 0 && this._controls.$absolute.children().slice(t).remove(), this._controls.$absolute.find(".active").removeClass("active"), this._controls.$absolute.children().eq(n.inArray(this.current(), this._pages)).addClass("active"))
...
function(s, o, t, e) {
    ...
    var i = function(t) {
        ...
        }, this._core.options = s.extend({}, i.Defaults, this._core.options), this.$element.on(this._handlers), s(o).on("hashchange.owl.navigation", s.proxy(function(t) {
