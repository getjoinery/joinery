...
<link rel="stylesheet" id="wp-block-library-css" href="<?php echo PathHelper::getThemeFilePath('style.min.css', 'assets/css', 'web', 'jeremytunnell'); ?>" type="text/css" media="all">
<!-- Meks shortcodes CSS removed - files not present -->
...
<link rel="stylesheet" id="typology-main-css" href="<?php echo PathHelper::getThemeFilePath('min.css', 'assets/vendors/wordpress/themes/typology/assets/css', 'web', 'jeremytunnell'); ?>" type="text/css" media="all">
...
<!-- jquery-migrate removed - file not present -->

<link rel="icon" href="/favicon.ico" />
<link rel="icon" href="<?php echo PathHelper::getThemeFilePath('favicon-32x32.png', 'assets/vendors/wordpress/themes/typology/assets/img', 'web', 'jeremytunnell'); ?>" sizes="32x32" />
<link rel="icon" href="<?php echo PathHelper::getThemeFilePath('android-chrome-192x192.png', 'assets/vendors/wordpress/themes/typology/assets/img', 'web', 'jeremytunnell'); ?>" sizes="192x192" />
<link rel="apple-touch-icon-precomposed" href="<?php echo PathHelper::getThemeFilePath('apple-touch-icon.png', 'assets/vendors/wordpress/themes/typology/assets/img', 'web', 'jeremytunnell'); ?>" />
<meta name="msapplication-TileImage" content="<?php echo PathHelper::getThemeFilePath('android-chrome-192x192.png', 'assets/vendors/wordpress/themes/typology/assets/img', 'web', 'jeremytunnell'); ?>" />
	...
	<h1 class="site-title h4"><a href="/" rel="home"><img class="typology-logo" src="<?php echo PathHelper::getThemeFilePath('typology_logo.png', 'assets/vendors/wordpress/themes/typology/assets/img', 'web', 'jeremytunnell'); ?>" alt="JeremyTunnell.com"></a></h1>	
</div>
...
<p><a href="/sitemap">Sitemap</a></p>
	...
	<span class="site-title h4"><a href="/" rel="home"><img class="typology-logo" src="<?php echo PathHelper::getThemeFilePath('typology_logo.png', 'assets/vendors/wordpress/themes/typology/assets/img', 'web', 'jeremytunnell'); ?>" alt="JeremyTunnell.com"></a></span>	
</div>
...
?>
	...
	<img alt="" src="<?php echo PathHelper::getThemeFilePath('jeremy.jpg', 'assets/images', 'web', 'jeremytunnell'); ?>" class="avatar avatar-90 photo avatar-default" height="90" width="90">
...
<script type="text/javascript" src="<?php echo PathHelper::getThemeFilePath('imagesloaded.min.js', 'assets/js', 'web', 'jeremytunnell'); ?>"></script>
<script type="text/javascript">
/* <![CDATA[ */
var typology_js_settings = {"rtl_mode":"","header_sticky":"1","logo":"<?php echo PathHelper::getThemeFilePath('typology_logo.png', 'assets/vendors/wordpress/themes/typology/assets/img', 'web', 'jeremytunnell'); ?>","logo_retina":"<?php echo PathHelper::getThemeFilePath('typology_logo.png', 'assets/vendors/wordpress/themes/typology/assets/img', 'web', 'jeremytunnell'); ?>","use_gallery":"1","slider_autoplay":"0","cover_video_image_fallback":""};
/* ]]> */
</script>
<script type="text/javascript" src="<?php echo PathHelper::getThemeFilePath('min.js', 'assets/vendors/wordpress/themes/typology/assets/js', 'web', 'jeremytunnell'); ?>"></script>
...
<?php	
	...
	function tableheader($headers, $class = '', $id="default"){
		//id VARIABLE TOGGLES BETWEEN STYLESHEETS
		echo "<table class='sortable admin_table' id='$id' cellspacing='0' summary=''>
			<caption></caption>
			<tr>";
