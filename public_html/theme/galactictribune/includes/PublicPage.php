				...
				<div class="container">
					<div class="row col-spacing-20">
						<div class="col-6 col-sm-6 col-lg-3">
							<h3>The Galactic Tribune</h3>
						</div>
						<div class="col-6 col-sm-6 col-lg-3">
							<h6 class="font-small font-weight-normal uppercase">Useful Links</h6>
							<ul class="list-dash">
								<li><a href="https://jeremytunnell.com">Jeremy Tunnell</a></li>
								<!--<li><a href="#">Team</a></li>
						...
						<div class="col-6 col-sm-6 col-lg-3">
							<h6 class="font-small font-weight-normal uppercase">Install Guides</h6>
							<ul class="list-dash">
								<li><a href="https://urbit.org/getting-started">Urbit Install Guide</a></li>
								<li><a href="https://jeremytunnell.com/2021/01/09/how-to-install-urbit-on-a-linode-vps">Install on a VPS (Linode)</a></li>
							</ul>
						</div>
						<!--
						<div class="col-6 col-sm-6 col-lg-3">
					...
					<div class="row col-spacing-10">
						<div class="col-12 col-md-6 text-center text-md-left">
							<p>&copy; 2021 Galactic Tribune, All Rights Reserved.</p>
						</div>
						<!--
