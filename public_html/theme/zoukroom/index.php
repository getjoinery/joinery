<?php
	...
	require_once(LibraryFunctions::get_theme_file_path('FormWriterPublic.php', '/includes'));	
		...
		<div class="uk-position-relative uk-visible-toggle uk-light uk-box-shadow-small uk-overflow-hidden uk-border-rounded"
		 tabindex="-1" data-uk-slider="autoplay: true">
			<ul class="uk-slider-items uk-child-width-1-1">
				<li>
					<img src="/uploads/DSC07869-5800x3301_cdwbsqf.jpg" alt="Slide">
				...
				<li>
					<img src="/uploads/DSC04428-5800x3300_1zdh7ix0.jpg" alt="Slide">
				...
				<li>
					<img src="/uploads/DSC08382-5800x3300_k1xz70vl.jpg" alt="Slide">
					<div class="uk-position-cover uk-overlay-xlight uk-flex uk-flex-middle uk-padding-slide">
						<div class="uk-width-1-2@m">
