          ...
          <div class="relative shadow-xl sm:rounded-2xl sm:overflow-hidden">
            ...
            <div class="relative px-4 py-16 sm:px-6 sm:py-24 lg:py-32 lg:px-8">
              <h1 class="text-center text-4xl font-extrabold tracking-tight sm:text-5xl lg:text-6xl">
                ...
                <span class="block text-white">Online Zouk Lessons</span>
              </h1>
...
<div class="py-12 bg-white">
  <div class="max-w-xl mx-auto px-4 sm:px-6 lg:max-w-7xl lg:px-8">
    <h2 class="sr-only">Benefits of Social Emotional Learning</h2>
    <dl class="space-y-10 lg:space-y-0 lg:grid lg:grid-cols-3 lg:gap-8">
      <div>
        ...
        <dd class="mt-2 text-base text-gray-500">
          Social Emotional Learning (SEL) results in the development and maintenance of healthy relationships
        </dd>
      </div>
      ...
      <div>
        ...
        <dd class="mt-2 text-base text-gray-500">
          SEL exercises teach effective communication strategies to use during conflict with family and peers
        </dd>
      </div>
      ...
      <div>
        ...
        <dd class="mt-2 text-base text-gray-500">
          SEL exercises help kids understand and apply boundaries within daily living 
        </dd>
      </div>
    </dl>
  </div>
