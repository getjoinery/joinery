					...
					<div class="contact-item-wrap">
                        ...
                        <div class="contact-item">
                            ...
                            <div class="media-body">
                                ...
                                <span class="contact-item_text"><a href="/checkout?r=<?php echo $key; ?>">Remove</a></span>
                        ...
                        <div class="contact-item">
                            ...
                            <div class="media-body">
                                ...
                                <span class="contact-item_title"><a href="/checkout?r=<?php echo $key; ?>">Remove item</a></span>
                            </div>
                        </div>
						<?php 
							}
					...
					<div class="contact-item-wrap mt-40">
						...
						if($session->get_permission() >= 8 && ($_SESSION['test_mode'] || $settings->get_setting('debug'))){
							...
							foreach($page_vars['all_coupons'] as $coupon){
								$formwriter = $page->getFormWriter('form_test_coupon', ['action' => '/checkout', 'method' => 'GET']);
						...
						$formwriter = $page->getFormWriter('form_coupon', ['action' => '/checkout', 'method' => 'GET']);
						$formwriter->begin_form();
						...
						?>
						<div class="media-body">
							<span class="contact-item_text">Coupon applied: <?php echo $coupon_code . ' ('.$coupon_code_obj->get_readable_discount(). ' discount ) <a href="/checkout?rc='.$coupon_code.'">remove</a>'; ?></span>
						</div>
						<?php
						}
						?>
                ...
                <div class="col-lg-6 col-xl-5">
					...
					if($require_login){
						...
						if($cart->is_billing_user_complete()){
							...
							echo '<a href="/checkout?newbilling=1" class="btn btn-secondary">Change billing user</a>';
							echo '<br><br>';
						}
						else{
							/*
							...
							<?php	
							*/
							$formwriter = $page->getFormWriter('form2', ['action' => '/checkout']);
							$formwriter->begin_form();
