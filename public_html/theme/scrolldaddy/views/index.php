...
require_once(PathHelper::getThemeFilePath('PublicPage.php', 'includes'));
	...
	require_once(PathHelper::getIncludePath('plugins/store/logic/pricing_logic.php'));
                    ...
                    <div class="hero-style1">
                        ...
                        <div class="client-box mb-sm-0 mb-3">
                            <div class="client-thumb-group">
                                <div class="thumb"><img src="/theme/scrolldaddy/assets/img/shape/client-1-1.png" alt="avater"></div>
                                <div class="thumb"><img src="/theme/scrolldaddy/assets/img/shape/client-1-2.png" alt="avater"></div>
                                <div class="thumb"><img src="/theme/scrolldaddy/assets/img/shape/client-1-3.png" alt="avater"></div>
            ...
            <div class="row gy-4 justify-content-center">
                <div class="col-md-6 col-xl-3">
                    <div class="feature-card ">
                        <!--<div class="box-icon">
                            <img src="/theme/scrolldaddy/assets/img/icon/feature_1_1.svg" alt="Icon">
                        </div>-->
