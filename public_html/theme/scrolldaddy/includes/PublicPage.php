...
class PublicPage extends PublicPageBase {
	...
	public static function BeginPage($title='', $options=array()) {
		...
		$output .= '
    <div class="breadcumb-wrapper " data-bg-src="/theme/scrolldaddy/assets/img/bg/breadcumb-bg.jpg">
        <div class="container">
...
==============================-->
   <div class="space overflow-hidden ">
	...
	public function public_header($options=array()) {
		...
		$numitems = $menu_data['cart']['count'] ?? 0;
		if($numitems){
...
<head>
	...
	<!--
    <link rel="apple-touch-icon" sizes="57x57" href="/theme/scrolldaddy/assets/img/favicons/apple-icon-57x57.png">
    <link rel="apple-touch-icon" sizes="60x60" href="/theme/scrolldaddy/assets/img/favicons/apple-icon-60x60.png">
    <link rel="apple-touch-icon" sizes="72x72" href="/theme/scrolldaddy/assets/img/favicons/apple-icon-72x72.png">
    <link rel="apple-touch-icon" sizes="76x76" href="/theme/scrolldaddy/assets/img/favicons/apple-icon-76x76.png">
    <link rel="apple-touch-icon" sizes="114x114" href="/theme/scrolldaddy/assets/img/favicons/apple-icon-114x114.png">
    <link rel="apple-touch-icon" sizes="120x120" href="/theme/scrolldaddy/assets/img/favicons/apple-icon-120x120.png">
    <link rel="apple-touch-icon" sizes="144x144" href="/theme/scrolldaddy/assets/img/favicons/apple-icon-144x144.png">
    <link rel="apple-touch-icon" sizes="152x152" href="/theme/scrolldaddy/assets/img/favicons/apple-icon-152x152.png">
    <link rel="apple-touch-icon" sizes="180x180" href="/theme/scrolldaddy/assets/img/favicons/apple-icon-180x180.png">
    <link rel="icon" type="image/png" sizes="192x192" href="/theme/scrolldaddy/assets/img/favicons/android-icon-192x192.png">
    <link rel="icon" type="image/png" sizes="32x32" href="/theme/scrolldaddy/assets/img/favicons/favicon-32x32.png">
    <link rel="icon" type="image/png" sizes="96x96" href="/theme/scrolldaddy/assets/img/favicons/favicon-96x96.png">
    <link rel="icon" type="image/png" sizes="16x16" href="/theme/scrolldaddy/assets/img/favicons/favicon-16x16.png">
    <link rel="manifest" href="/theme/scrolldaddy/assets/img/favicons/manifest.json">
    <meta name="msapplication-TileColor" content="#ffffff">
    <meta name="msapplication-TileImage" content="/theme/scrolldaddy/assets/img/favicons/ms-icon-144x144.png">
    ...
    <link rel="stylesheet" href="/theme/scrolldaddy/assets/css/responsive-utils.css?v=5">
    <!-- Theme Custom CSS -->
        ...
        <div class="preloader">
            <div class="loading-container">
                ...
                <div class="preloader-logo">
                    <a class="icon-masking" href="home-hr-management.html"><span data-mask-src="/theme/scrolldaddy/assets/img/preloader.svg" class="mask-icon"></span><img src="/theme/scrolldaddy/assets/img/preloader.svg" alt="Sassa"></a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="th-menu-wrapper">
        <div class="th-menu-area text-center">
			...
			<a class="icon-masking" href="/"><span data-mask-src="/static_files/scrolldaddylogonopadding.svg" class="mask-icon"></span><img src="/static_files/scrolldaddylogonopadding.svg" alt="ScrollDaddy" width="200"></a>
               <!-- <a href="/"><img src="/theme/scrolldaddy/assets/img/logo.svg" alt="Sassa"></a>-->
            </div>
                        ...
                        <div class="widget footer-widget">
                            <div class="th-widget-about">
								...
								<h3 class="hero-title">ScrollDaddy</h3>
                                    <!--<a class="icon-masking" href="index.html"><span data-mask-src="/theme/scrolldaddy/assets/img/logo.svg" class="mask-icon"></span><img src="/theme/scrolldaddy/assets/img/logo.svg" alt="Sassa"></a>-->
                                </div>
...
============================== -->
    ...
    <!-- Main Js File -->
    <script src="/theme/scrolldaddy/assets/js/main.js?v=3"></script>
    <!-- ScrollDaddy Plugin JS -->
    <script src="/theme/scrolldaddy/assets/js/scrolldaddy-plugin.js?v=2"></script>
