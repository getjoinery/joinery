<?php
/**
 * PublicPage for Linka Reference Theme
 *
...
<html lang="en">
    <head>
        ...
        <!-- Bootstrap CSS -->
        <link rel="stylesheet" href="/theme/linka-reference/assets/css/bootstrap.min.css">
        <!-- Owl Carousel CSS -->
        <link rel="stylesheet" href="/theme/linka-reference/assets/css/owl.theme.default.min.css">
        <link rel="stylesheet" href="/theme/linka-reference/assets/css/owl.carousel.min.css">
        <!-- Magnific Popup CSS -->
        <link rel="stylesheet" href="/theme/linka-reference/assets/css/magnific-popup.min.css">
        <!-- Animate CSS -->
        <link rel="stylesheet" href="/theme/linka-reference/assets/css/animate.min.css">
        <!-- Boxicons CSS -->
        <link rel="stylesheet" href="/theme/linka-reference/assets/css/boxicons.min.css">
        <!-- Flaticon CSS -->
        <link rel="stylesheet" href="/theme/linka-reference/assets/css/flaticon.css">
        <!-- MeanMenu CSS -->
        <link rel="stylesheet" href="/theme/linka-reference/assets/css/meanmenu.min.css">
        <!-- Nice Select CSS -->
        <link rel="stylesheet" href="/theme/linka-reference/assets/css/nice-select.min.css">
        <!-- Linka Theme CSS -->
        <link rel="stylesheet" href="/theme/linka-reference/assets/css/style.css">
        <!-- Responsive CSS -->
        <link rel="stylesheet" href="/theme/linka-reference/assets/css/responsive.css">
        <!-- Joinery Custom CSS -->
        <link rel="stylesheet" href="/theme/linka-reference/assets/css/joinery-custom.css">

        <!-- Favicon -->
        <link rel="icon" type="image/png" href="/theme/linka-reference/assets/images/favicon.png">
    ...
    public function public_footer($options = array()) {
        ...
        <!-- jQuery -->
        <script src="/theme/linka-reference/assets/js/jquery.min.js"></script>
        <!-- Bootstrap JS -->
        <script src="/theme/linka-reference/assets/js/bootstrap.bundle.min.js"></script>
        <!-- OWL Carousel JS -->
        <script src="/theme/linka-reference/assets/js/owl.carousel.min.js"></script>
        <!-- Magnific Popup JS -->
        <script src="/theme/linka-reference/assets/js/magnific-popup.min.js"></script>
        <!-- WOW JS -->
        <script src="/theme/linka-reference/assets/js/wow.min.js"></script>
        <!-- MeanMenu JS -->
        <script src="/theme/linka-reference/assets/js/meanmenu.min.js"></script>
        <!-- Nice Select JS -->
        <script src="/theme/linka-reference/assets/js/nice-select.min.js"></script>
        <!-- Form Validator JS -->
        <script src="/theme/linka-reference/assets/js/form-validator.min.js"></script>
        <!-- AjaxChimp JS -->
        <script src="/theme/linka-reference/assets/js/ajaxchimp.min.js"></script>
        <!-- Contact Form JS -->
        <script src="/theme/linka-reference/assets/js/contact-form-script.js"></script>
        <!-- Custom JS -->
        <script src="/theme/linka-reference/assets/js/custom.js"></script>
    </body>
</html>
        <?php
    }
