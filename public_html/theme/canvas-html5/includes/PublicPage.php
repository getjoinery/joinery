...
<head>
    ...
    <link rel="stylesheet" href="<?php echo PathHelper::getThemeFilePath('style.css', 'assets/css', 'web', 'canvas-html5'); ?>">
    <link rel="stylesheet" href="<?php echo PathHelper::getThemeFilePath('custom.css', 'assets/css', 'web', 'canvas-html5'); ?>">
</head>
<body>
<?php
...
?>
    ...
    <script src="<?php echo PathHelper::getThemeFilePath('script.js', 'assets/js', 'web', 'canvas-html5'); ?>"></script>
</body>
</html>
<?php
    }
