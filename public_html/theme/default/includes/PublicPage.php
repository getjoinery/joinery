			...
			<div class="wrap">
				<aside class="widget-area" role="complementary" aria-label="Footer">
					<div class="widget-column footer-widget-1">
						...
						<div class="textwidget"><p>General questions:  <a class="izfooter" href="mailto:info@integralzen.org">info@integralzen.org</a></p></div>
						<div class="textwidget"><p>Retreat or Course questions:  <a class="izfooter" href="mailto:registrar@integralzen.org">registrar@integralzen.org</a></p></div>
						<div class="textwidget"><p>Website help:  <a class="izfooter" href="mailto:webmaster@integralzen.org">webmaster@integralzen.org</a></p></div>
						</section>			
					</div>
...
<!--
							<nav class="social-navigation" role="navigation" aria-label="Footer Social Links Menu">
								<div class="menu-footer-menu-container"><ul id="menu-footer-menu" class="social-links-menu"><li id="menu-item-7078" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-7078"><a class="izfooter" href="https://www.facebook.com/IntegralZen"><span class="screen-reader-text">Facebook</span><svg class="icon icon-facebook" aria-hidden="true" role="img"> <use href="#icon-facebook" xlink:href="#icon-facebook"></use> </svg></a></li>
		<li id="menu-item-7079" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-7079"><a class="izfooter" href="https://www.instagram.com/integralzen/"><span class="screen-reader-text">Instagram</span><svg class="icon icon-instagram" aria-hidden="true" role="img"> <use href="#icon-instagram" xlink:href="#icon-instagram"></use> </svg></a></li>
		<li id="menu-item-7080" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-7080"><a class="izfooter" href="https://twitter.com/integralzen"><span class="screen-reader-text">Twitter</span><svg class="icon icon-twitter" aria-hidden="true" role="img"> <use href="#icon-twitter" xlink:href="#icon-twitter"></use> </svg></a></li>
