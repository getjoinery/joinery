<?php
	...
	echo '<h3>Spawned children of point '. htmlspecialchars($raw_input, ENT_QUOTES, 'UTF-8') .'</h3>';

	$results= json_decode(exec('node /var/www/html/test/node/get-spawned.js '.$pointnum));
