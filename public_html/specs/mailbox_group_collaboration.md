# Mailbox — Group / Team Collaboration (Deferred)

## Status: deferred

This is the **team layer** for the mailbox plugin — turning a shared mailbox
...
`plugins/mailbox/docs/overview.md` (extend the **Mailbox Reader** section; do not
