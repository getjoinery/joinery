...
| `data/managed_node_class.php` | `mgn_backup_verify_time timestamp(6)`, `mgn_backup_verify_level int4`, `mgn_backup_verify_outcome varchar(20)`, `mgn_backup_verify_message text`, `mgn_backup_shelf_problem text` |
