...
**Remaining scope here:** the four plugins' page-JS migrations below — packaged
for execution (alongside the core `/ajax/` misc estate) in
[`ajax_estate_migration.md`](ajax_estate_migration.md).
