...
$today = date("m-d-Y");
$startdate = LibraryFunctions::fetch_variable('startdate', '06-01-2020', 0, '');
...
echo $formwriter->begin_form("uniForm", "post", "admin_analytics_stats");
...
foreach ($email_content_stats as $email_content_stats => $values)
{		
