<?php
	...
	require_once(LibraryFunctions::get_logic_file_path('ctldfilters_edit_logic.php'));
	...
	$user = $page_vars['user'];
	$is_edit_day = $page_vars['is_edit_day'];
	...
	echo PublicPageSassa::BeginPage('Add/Edit Filters', $hoptions);
	...
	echo $formwriter->begin_form('contact-form style2 ajax-contact', 'POST', '/profile/ctldfilters_edit', true);
