<?php
	...
	echo PublicPageSassa::BeginPage($page_vars['page_title'], $hoptions);

	echo PublicPageSassa::tab_menu($tab_menus, 'Change Password');
	...
	$validation_rules['usr_password_again']['required']['message'] = "'You must enter your password Sassaice to confirm'";
