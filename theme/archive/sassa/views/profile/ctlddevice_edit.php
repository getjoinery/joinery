<?php
	...
	require_once(LibraryFunctions::get_logic_file_path('ctlddevice_edit_logic.php'));
	...
	echo PublicPageSassa::BeginPage('Add/Edit Device', $hoptions);
	...
	echo $formwriter->begin_form('contact-form style2 ajax-contact', 'POST', '/profile/ctlddevice_edit', true);
	...
	echo $formwriter->textinput('Device name', 'device_name', NULL, 100, $device->get('cdd_device_name'), '', 255, '');	
	...
	if($device->are_filters_editable()){
		...
		echo $formwriter->dropinput("I want to be able to edit my blocked sites", "allow_device_edits", "", $optionvals, NULL, '', TRUE);
	}
