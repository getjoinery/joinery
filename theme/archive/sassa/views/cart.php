<?php
	...
	echo PublicPageSassa::BeginPage('Checkout');
		...
		if($settings->get_setting('coupons_active')){
			...
			foreach($cart->coupon_codes as $coupon_code){
				...
				<div class="media-body">
					<span class="contact-item_text">Coupon applied: <?php echo $coupon_code . ' ('.$coupon_code_obj->get_readable_discount(). ' discount ) <a href="/cart?r='.$key.'">remove</a>'; ?></span>
				</div>
                ...
                <div class="col-lg-6 col-xl-5">
                    <div class="contact-item-wrap">
                        ...
                        <div class="contact-item">
                            ...
                            <div class="media-body">
                                <span class="contact-item_title"><?php echo $product->get('pro_name').' '. $product_version->prv_version_name;?></span>
