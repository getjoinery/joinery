...
class PublicPageSassa extends PublicPageMaster {
                    ...
                    <div class="row align-items-center justify-content-between">
                        <div class="col-auto">
                            <div class="header-logo">
                                <a class="icon-masking" href="home-hr-management.html"><span data-mask-src="/theme/sassa/assets/img/logo.svg" class="mask-icon"></span><img src="/theme/sassa/assets/img/logo.svg" alt="Sassa"></a>
                            </div>
                        </div>
                        <div class="col-auto">
