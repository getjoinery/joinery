...
class FormWriter extends FormWriterMaster { 
	...
	//FORM STYLING
	protected $fileinput_container_class = 'col-md-6 form-group';
	protected $fileinput_input_class = '';
	
	protected $text_container_class = 'col-md-6 form-group';
	protected $text_label_class = '';
	
	protected $textintput_container_class_horizontal = 'row';
	protected $textintput_label_class_horizontal = 'col-md-6 form-group';
	protected $textintput_container_class = 'col-md-6 form-group';
	protected $textintput_label_class = '';
	protected $textintput_input_class = '';
	
	protected $textbox_container_class = 'col-md-6 form-group';
	protected $textbox_textarea_class = '';

	protected $checkboxinput_container_class = 'col-md-6 form-group';
	protected $checkboxinput_input_class = '';
	
	protected $checkboxList_container_class = 'col-md-6 form-group';
	protected $checkboxList_wrapper_class = '';
	protected $checkboxList_input_class_checkbox = '';	
	protected $checkboxList_input_class_radio = '';	
	
	protected $timeinput_container_class = 'col-md-6 form-group';
	protected $timeinput_input_class = 'timepicker';
	
	protected $dropinput_container_class = 'col-md-6 form-group';
